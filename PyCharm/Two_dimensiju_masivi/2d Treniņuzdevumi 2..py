#1. Uzrakstīt programmu, kas saskaita divus 2x2 masīvus, saskaitot atbilstošos masīvu elementus. Summu glabāt trešajā masīvā.
...
for i in range(len(d)):
    ...
    for j in range(len(d[i])):
        summ += d[i][j]
    print(i+1, '. rindas summa = ',summ, ' un videjā vērtība = ',summ/len(d[i]))
...
# tāds pat masīvs, tikai arī zem diagonāles ir vieninieki